      ...
      return (
        <>
          ...
          <div
            ...
            className={cn("min-h-screen w-[--sidebar-width]", isMobile ? "hidden" : "flex flex-col", className)}
    ...
    return (
      <>
        ...
        >
          ...
          <div
            className={cn(
              "duration-200 relative min-h-screen w-[--sidebar-width] bg-transparent transition-[width] ease-linear",
          ...
          <div
            className={cn(
              "duration-200 fixed inset-y-0 min-h-screen w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
              side === "left"
