            ...
            <ChartContainer config={chartConfigGoals} className="h-[300px] w-full">
              <ResponsiveContainer>
                <BarChart data={athletes} layout="vertical">
                  ...
                  />
                  <Legend />
                  <Bar dataKey="goals" name="Gols" fill="hsl(var(--chart-1))" radius={4} />
                </BarChart>
              </ResponsiveContainer>
            </ChartContainer>
          </CardContent>
            ...
            <ChartContainer config={chartConfigSalary} className="h-[300px] w-full">
              <ResponsiveContainer>
                <BarChart data={salaryData} layout="vertical">
                  ...
                  />
                  <Legend />
                  <Bar dataKey="salary" name="Salário" fill="hsl(var(--chart-2))" radius={4} />
                </BarChart>
              </ResponsiveContainer>
            </ChartContainer>
          </CardContent>
            ...
            <ChartContainer config={chartConfigAge} className="h-[300px] w-full">
              <ResponsiveContainer>
                <BarChart data={ageData}>
                  ...
                  />
                  <Legend />
                  <Bar dataKey="age" name="Idade" fill="hsl(var(--chart-3))" radius={4} />
                </BarChart>
              </ResponsiveContainer>
            </ChartContainer>
          </CardContent>
